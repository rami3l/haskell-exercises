...
-- Monad :: (Type -> Type) -> Constraint -- eg. Monad Maybe
-- Eq :: Type -> Constraint -- eg. Eq Int
-- So @m@ cannot be both @Monad@ and @Eq@.
-- The @n@ below is of kind @(Type -> Type)@, just like @Maybe@.
instance Question10 (Monad n, Eq m, Show a)
